...
- 2026-07-08: Windows complete-app parent track added in Obsidian; repo W0/W1
  ...
  artifact convention.
- 2026-07-08: Plan 019 Step 3 started with Windows ffmpeg input builders and
  recording primary-input layout tests for display, camera, and microphone.
...
| 019  | Finish Windows v1 capture and package acceptance                                                                                                                    | P2       | L      | 001, 002, 003, 006, 012                        | IN PROGRESS (2026-07-08; Windows input-builder seam started, real Windows discovery/package/capture/signing evidence pending)                                                       |
...
- **P7-S3 Windows capture MVP - IN PROGRESS**: Plan 019 Step 3. Windows ffmpeg
  input builders and recording primary-input tests now cover display, camera,
  and mic variants; source discovery and on-box recording evidence are still
  pending.

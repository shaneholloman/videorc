...
- 2026-07-08: Plan 019 Step 3 started with Windows ffmpeg input builders,
  ...
  primary-input layout tests for display, camera, and microphone.
...
- **P7-S3 Windows capture MVP - IN PROGRESS**: Plan 019 Step 3. Windows ffmpeg
  ...
  variants; preview capture pipelines, dshow symbolic-link behavior, and on-box
  recording evidence are still pending.
